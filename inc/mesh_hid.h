...
#define MESH_HID_OP_HID_CMD_ENC     BT_MESH_MODEL_OP_3(0x40, MESH_HID_COMPANY_ID)
#define MESH_HID_OP_TEXT_ENC        BT_MESH_MODEL_OP_3(0x41, MESH_HID_COMPANY_ID)
#define MESH_HID_OP_KEY_EXCHANGE    BT_MESH_MODEL_OP_3(0x42, MESH_HID_COMPANY_ID)
#define MESH_HID_OP_KEY_CONFIRM     BT_MESH_MODEL_OP_3(0x43, MESH_HID_COMPANY_ID)

/* GPIO command opcodes (require PIN auth like HID) */
#define MESH_HID_OP_GPIO_CMD        BT_MESH_MODEL_OP_3(0x50, MESH_HID_COMPANY_ID)
#define MESH_HID_OP_GPIO_CMD_ENC    BT_MESH_MODEL_OP_3(0x51, MESH_HID_COMPANY_ID)
